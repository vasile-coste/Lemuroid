...
But do not worry, i've build a tutorial on how to add an example on how i did it with AzaharPlus [here](https://github.com/vasile-coste/LemuroidCores/blob/master/CORE_CREATION_EXAMPLE.md). So feel free to experiment!
